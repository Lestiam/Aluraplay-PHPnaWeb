<?php
require_once __DIR__ . '/inicio-html.php'; //traz o cabeçalho em html
    ...
    <?php foreach ($videoList as $video): /*mesclei php com html, agora esse "li" esta dentro do meu foreach. Para cada um dos li no meu banco de dados, esse li será exibido*/ ?>
        <li class="videos__item">
            <iframe width="100%" height="72%"
                    src="<?= $video->url;//<?= é a mesma coisa que abrir uma tag php e escrever echo     ?>"
...
<?php require_once __DIR__ . '/fim-html.php'; //fim do html